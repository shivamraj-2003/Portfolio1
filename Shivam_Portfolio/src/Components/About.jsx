        ...
        <>
            <div name="about" className='main-container bg-gray-100 py-10 px-4 md:px-0'>
                ...
                <div className='flex flex-col-reverse items-center md:flex-row'>
                    <div className='w-3/4 h-2/4 md:w-1/2 flex justify-center'>
                        <img className='w-full md:w-fit rounded-full h-auto md:h-auto shadow-lg' src={ data.image } alt="Profile" />
                    </div>
