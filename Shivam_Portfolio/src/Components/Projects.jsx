...
import dn from "../videos/dn.mp4"
import ln from "../videos/ln.mp4"
    ...
    const [projects, setProjects] = useState([
        {
            ...
            description: `The Website where you write valid Json Schema and it generated a dynamic Form from it.`,
            imageUrl: a12,
            videourl: dn,
            technology: "HTML,Tailwind CSS,React Js,Json,Javascript",
            projectUrl: 'https://dynamicformzigment.netlify.app/',

        },{
            title: 'Animated Responsive Webpage',
            description: `The Website which shows animated upon submitting login credentials. `,
            imageUrl: a13,
            videourl: ln,
            technology: "HTML,Tailwind CSS,React Js,Javascript",
            projectUrl: 'https://slogin-page1.netlify.app/',
        ...
        },
        {
            ...
            description: `The website you Where users used to add different
                                data
                                and to remove it,Edit it,although all completed ,pending,overdue tasks is show and user can search tasks.`,
            imageUrl: a1,
            videourl: td,
