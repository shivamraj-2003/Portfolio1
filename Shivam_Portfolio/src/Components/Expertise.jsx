...
const skills = [
    "C", "C++", "Baisc Data Structures & Algorithms", "HTML", "CSS", "Bulma CSS", "JavaScript", "React JS",
    "Tailwind CSS", "BootStrap", "Git & GitHub", "Application Page Interfaces(API)", "Problem Solving", "Soft Skills", "State Management", "PostMan",
     "Axios", "My Sql","English","Python","Django","Fetch","Responsive WebDesign"
];
